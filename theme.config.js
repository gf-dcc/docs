export default {
  ...
  chat: {
    link: 'https://join.slack.com/t/gfbrcaprecanceratlas/shared_invite/zt-1s4ahne9e-7wlj1Db02KZtJ6bJxlqnfA',
    icon: <svg width="50" height="50" viewBox="0 0 248 204" xmlns="http://www.w3.org/2000/svg">
