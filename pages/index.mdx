...
- May initially focus on a data type/research question in which they specialize, but should eventually share data and work together without boundaries to create more collaborative projects.
